...
class ProductsController Extends AdminBaseController
{
    ...
    {
        return view('admin.products.create', array('brands' => Vehicles::all(), 'depts' => Department::all()));
    }
    ...
    public function manageProduct()
    {
        ...
        return view('admin.products.manage', array('products' => $products));
    }
    ...
    public function EditProduct($id)
    {
        ...
        return view('admin.products.edit', array('product' => $product, 'vehicleProducts' => $vehicleProducts, 'vehicles' => $vehicle, 'depts' => Department::all()));
