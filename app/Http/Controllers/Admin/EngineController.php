...
class EngineController extends AdminBaseController
{
    ...
    */
    ...
    {
        $models = Moodel::all();
        return view('admin.engine.addengine')->with('models', $models);
    ...
    public function saveEngine()
    {
        ...
        if ($model->save()) {
            return redirect('admin/manageengine');
        }
    ...
    public function manage()
    {
        ...
        return view('admin.engine.manageengine')->with('engines', $engines);
    }
    ...
    public function edit($id)
    {
        ...
        $models = Moodel::all();
        return view('admin.engine.editengine')->with('engine', $engine)->with('models', $models);
    }
