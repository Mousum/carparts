...
class DepartmentsController extends AdminBaseController {
    ...
    public function Index() {
        ...
        return view('admin.Dept.Index')->with('depts', $data);
    }
    ...
    public function Create() {
        ...
        return view('admin.Dept.Create')->with('brands', $brandData);
    }
    ...
    public function edit($id) {
        ...
        $dept = Department::find($id);
        return view('admin.Dept.Edit')->with('item', $dept)->with("brands", $brandData);
    }
