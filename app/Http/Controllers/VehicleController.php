...
class VehicleController extends AdminBaseController
{
    ...
    {
        return view('vehicle.create', array('brands' => Brand::all()));
    }
    ...
    public function  ManageVehicle()
    {
        ...
        return view('vehicle.manage', array('vehicles' => $vehicles));
    }
    ...
    public function  editVehicle($id)
    {
        ...
        return view('vehicle.edit', array('brands' => Brand::all(), 'item' => Vehicles::find($id)));
    }
