...
@section('content')
<h2 class="margin-none">Manage Sub Department &nbsp;<i class="fa fa-fw fa-pencil text-muted"></i><a href="{{URL::to('/createadmin/')}}" style="float:right; margin-bottom: 20px;" class="btn btn-inverse">Add Admin</a></h2>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                <table class="display" cellspacing="0" width="100%" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$ct= $sub['sub_department_id']}} </td>
                            <td>{{$sub['department_name']}} </td>
                            <td>{{$sub['sub_department_name']}}</td>


                            <td>
                                <a href="{{URL::to('/editsubdepartment/').'/'.$ct}}" title="Edit" class="btn btn-circle btn-success"><i class="icon-compose"></i></a>
