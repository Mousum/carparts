...
@section('content')
<h2 class="margin-none">Manage Model &nbsp;<i class="fa fa-fw fa-pencil text-muted"></i><a href="{{URL::to('admin/createmodel/')}}" style="float:right; margin-bottom: 20px;" class="btn btn-inverse">Add Admin</a></h2>
                ...
                <table class="display" cellspacing="0" width="100%" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::to('admin/editmodel/').'/'.$ct}}" title="Edit" class="btn btn-circle btn-success"><i class="icon-compose"></i></a>
...
<script>
    ...
    function myfunction(id) {
        ...
        if (confirm("Do you want to delete this item?") == true) {
            ...
            window.location.href = $('#base_url').val() + "/admin/deletemodel/" + id;
        } else {
            return false;
        }
