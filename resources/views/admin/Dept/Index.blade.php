...
@section('content')
<h2 class="margin-none">All Departments &nbsp;<i class="fa fa-fw fa-pencil text-muted"></i><a href="{{URL::to('admin/dept/create')}}" style="float:right; margin-bottom: 20px;" class="btn btn-inverse">Add Department</a></h2>
...
<!--                            <td>{{$item['brand_name']}} </td>
                            ...
                            <td>
                                <a href="{{URL::to('admin/dept/edit/').'/'.$item['department_id']}}" title="Edit" class="btn btn-circle btn-success"><i class="icon-compose"></i></a>
...
$(".delete").click(function(){
    var id =$(this).attr('data-id');
     $.ajax({
            url: $("#base_url").val() + "/admin/DeleteDepartment",
            type: 'POST',
            data: {id: id},
            dataType:'html',
