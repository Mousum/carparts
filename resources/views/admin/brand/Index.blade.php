...
@section('content')
<h2 class="margin-none">All Brands &nbsp;<i class="fa fa-fw fa-pencil text-muted"></i><a href="{{URL::to('admin/brands/create')}}" style="float:right; margin-bottom: 20px;" class="btn btn-inverse">Add Brand</a></h2>
                    ...
                    <tbody>
                       <?php $i=0;?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::to('admin/brands/edit/').'/'.$item['brand_id']}}" title="Edit" class="btn btn-circle btn-success"><i class="icon-compose"></i></a>

                                <!-- Trigger the modal with a button -->
                                <button type="button" class="btn btn-circle btn-danger" data-toggle="modal" data-target="#delModal{{$item['brand_id']}}"><i class="icon-trash-can"></i></button>
...
$(".delete").click(function(){
    var id =$(this).attr('data-id');
     $.ajax({
            url: $("#base_url").val() + "/admin/deleteBrand",
            type: 'POST',
            data: {id: id},
            dataType:'html',
