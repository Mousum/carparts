...
@section('content')
    <h2 class="margin-none">All Departments &nbsp;<i class="fa fa-fw fa-pencil text-muted"></i><a
                href="{{URL::to('admin/vehicle/create')}}" style="float:right; margin-bottom: 20px;" class="btn btn-inverse">Add
            Vehicle</a></h2>
                    ...
                    <table class="display" cellspacing="0" width="100%" id="myTable">
                        ...
                        @foreach($vehicles as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('admin/vehicle/edit/').'/'.$item->vehicle_id}}" title="Edit"
    ...
    <script>
        $(".delete").click(function () {
            ...
            $.ajax({
                url: $("#base_url").val() + "/admin/deletevehicle",
                type: 'POST',
                data: {id: id},
                dataType: 'html',
