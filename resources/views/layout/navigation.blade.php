 <div class="navbar hidden-print main" role="navigation">
                    ...
                    <ul class="main pull-right">
                        ...
                        <li class="dropdown username">
                            <a href="" class="dropdown-toggle" data-toggle="dropdown"><img src="{{URL::to('resources/assets/images/people/35/2.jpg')}}" class="img-circle" width="30"/> Bill Jonson <span class="caret"></span></a>
