...
@section('content')
    ...
    <div class="row">
        <form method="post" action="{{URL::to('vehicle/update/'.$item->vehicle_id)}}">
    ...
    <script>
        ...
        $("#brand").change(function () {
            $.get($("#base_url").val() + "/getmodels?brand=" + $(this).val(), function (data) {
        ...
        $("#model").change(function () {
            $.get($("#base_url").val() + "/getengine?model=" + $(this).val(), function (data) {
                var result = $.parseJSON(data);
                console.log(result);
