...
@section('content')
<h2 class="margin-none">All Events &nbsp;<i class="fa fa-fw fa-pencil text-muted"></i><a href="{{URL::to('events/create')}}" style="float:right; margin-bottom: 20px;" class="btn btn-inverse">Add Event</a></h2>
                    ...
                    <tbody>
                       <?php $i=0;?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::to('events/edit/').'/'.$item['event_id']}}" title="Edit" class="btn btn-circle btn-success"><i class="icon-compose"></i></a>
